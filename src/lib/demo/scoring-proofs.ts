  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        note: "GET /api/stream/messages?scope=group polls every 1.5s, sends auth-gated SSE events; clients reconnect on transport errors.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        status: "live",
        evidence: "/groups",
        evidenceLabel: "captain rec panel",
        note: "Captain-only RecommendedTeammates panel ranks Yes-respondents by sport overlap, proximity, and compat baseline; AI enriches the explanation when Groq is configured, deterministic reason renders otherwise.",
      },
    ],
  },
  {
