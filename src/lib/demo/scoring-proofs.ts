...
export const RUBRIC_CATEGORIES: RubricCategory[] = [
  {
    ...
    rows: [
      ...
      },
      {
        ...
        note: "Photo step exists, but R2 upload/processing is not claimed yet.",
      },
    ],
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        evidence: "/groups",
        evidenceLabel: "/groups",
        note: "Formation facts are visible; AI compatibility scoring is not yet surfaced.",
      },
    ],
  },
  {
    ...
    rows: [
      {
        ...
        note: "Group captain event creation is live; standalone /events/new is not wired.",
      },
      {
        id: "event-chat",
      ...
      },
      {
        ...
        status: "fallback",
        evidence: "/events",
        evidenceLabel: "captain reveal",
        note: "Deterministic venue/time/weather surfaces exist; Groq brief remains fallback copy.",
      },
      {
        id: "voting",
    ...
    rows: [
      {
        ...
        evidence: "/onboarding/profile",
        evidenceLabel: "/onboarding/profile",
        note: "Groq text extraction with deterministic keyword fallback when AI is offline.",
      },
      {
        ...
        evidence: "/onboarding/photo",
        evidenceLabel: "/onboarding/photo",
        note: "Manual photo step exists; Groq vision extraction is not claimed.",
      },
      {
        ...
        status: "pending",
        evidence: "/groups",
        evidenceLabel: "compat reason",
        note: "ai_cache exists for safe outputs; compatibility scoring UI is not claimed.",
      },
      {
        id: "ai-captain-brief",
        ...
        note: "Captain summary panel is deterministic; Groq-generated brief is not required for core demo.",
      },
      {
