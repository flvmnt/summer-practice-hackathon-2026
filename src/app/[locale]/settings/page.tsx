...
const COPY = {
  en: {
    ...
    panel: {
      ...
      aiBioButton: "Suggest from bio",
      aiPhotoButton: "Suggest from photo",
      aiLoadingLabel: "Analyzing...",
      aiNoBio: "Add a bio first so we can suggest sports.",
      aiNoResults: "No matching sports found yet.",
      aiRateLimited: "Too many requests. Try again in a minute.",
      sportLabels: {
        football: "Football",
  ...
  ro: {
    ...
    panel: {
      ...
      aiBioButton: "Sugerează din bio",
      aiPhotoButton: "Sugerează din poză",
      aiLoadingLabel: "Se analizează...",
      aiNoBio: "Adaugă mai întâi un bio ca să sugerăm sporturi.",
      aiNoResults: "Niciun sport potrivit găsit încă.",
      aiRateLimited: "Prea multe cereri. Încearcă peste un minut.",
      sportLabels: {
        football: "Fotbal",
        basketball: "Baschet",
        tennis: "Tenis",
